#Utilizando a lista de nomes em anexo, retorne a quantidade de nomes na lista
#qual o menor nome e qual o maior nome.
...
print("A quantidade de nomes é: ", len(nomes))
maiores = max(nomes,key =len)
menores = min (nomes, key=len)
